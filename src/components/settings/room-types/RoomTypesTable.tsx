        ...
        <>
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button aria-haspopup="true" size="icon" variant="ghost" id="roomtypestable-button-1" data-testid="roomtypestable-button-1">
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem asChild>
                      <Link href={`/settings/room-types/edit/${roomType.id}`} id="roomtypestable-link-editar" data-testid="roomtypestable-link-editar">Editar</Link>
                    </DropdownMenuItem>
