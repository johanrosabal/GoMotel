        ...
        <>
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button variant="ghost" size="icon" id="sinpeaccountsclientpage-button-1"><MoreHorizontal className="h-4 w-4" /></Button>
                </DropdownMenuTrigger>
    ...
    return (
        <div className="space-y-4">
            <div className="flex justify-end">
                <Button onClick={() => setIsFormOpen(true)} id="sinpeaccountsclientpage-button-a-adir-cuenta-sinpe">
