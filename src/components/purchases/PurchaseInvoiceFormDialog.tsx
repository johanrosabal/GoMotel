        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-4xl max-h-[90vh] flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto pr-6 pl-1">
                    <Form {...form}>
                        <form id="purchase-invoice-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-4" data-testid="purchaseinvoiceformdialog-main-form">
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <Select onValueChange={field.onChange} value={field.value} disabled={readOnly}>
                                                        <FormControl>
                                                            <SelectTrigger id="purchaseinvoiceformdialog-selecttrigger-1" data-testid="purchaseinvoiceformdialog-supplier-select">
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl><Input placeholder="FAC-12345" {...field} maxLength={25} readOnly={readOnly} id="purchaseinvoiceformdialog-input-fac-12345" data-testid="purchaseinvoiceformdialog-invoice-number-input" /></FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                                        />
                                                ...
                                                <FormItem>
                                                    ...
                                                    <div className="grid grid-cols-3 gap-2">
                                                        <Select onValueChange={setInvoiceDay} value={invoiceDay} disabled={readOnly}>
                                                            <FormControl>
                                                                <SelectTrigger id="purchaseinvoiceformdialog-selecttrigger-2" data-testid="purchaseinvoiceformdialog-day-select">
                                                        ...
                                                        <Select onValueChange={setInvoiceMonth} value={invoiceMonth} disabled={readOnly}>
                                                            <FormControl>
                                                                <SelectTrigger id="purchaseinvoiceformdialog-selecttrigger-3" data-testid="purchaseinvoiceformdialog-month-select">
                                                        ...
                                                        <Select onValueChange={setInvoiceYear} value={invoiceYear} disabled={readOnly}>
                                                            <FormControl>
                                                                <SelectTrigger id="purchaseinvoiceformdialog-selecttrigger-4" data-testid="purchaseinvoiceformdialog-year-select">
                                            ...
                                            {!readOnly && (
                                                <Popover open={productSearchOpen} onOpenChange={setProductSearchOpen}>
                                                    <PopoverTrigger asChild>
                                                        <Button type="button" variant="outline" size="sm" className="gap-2" id="purchaseinvoiceformdialog-button-a-adir-producto" data-testid="purchaseinvoiceformdialog-add-button">
                                                            ...
                                                            <TableRow key={item.id}>
                                                                ...
                                                                <TableCell>
                                                                    <Input
                                                                        ...
                                                                        min="1"
                                                                        readOnly={readOnly} id="purchaseinvoiceformdialog-input-1" data-testid="purchaseinvoiceformdialog-quantity-input"
                                                                    />
                                                                </TableCell>
                                                                <TableCell>
                                                                    <Input
                                                                        ...
                                                                        readOnly={readOnly} id="purchaseinvoiceformdialog-input-2" data-testid="purchaseinvoiceformdialog-cost-price-input"
                                                                    />
                                                                ...
                                                                {!readOnly && (
                                                                    <TableCell>
                                                                        <Button type="button" variant="ghost" size="icon" className="h-8 w-8 text-destructive" onClick={() => remove(index)} id="purchaseinvoiceformdialog-button-1" data-testid="purchaseinvoiceformdialog-delete-button">
                                            ...
                                            <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                                                ...
                                                <FormControl>
                                                    <Switch
                                                        ...
                                                        disabled={readOnly} id="purchaseinvoiceformdialog-switch-1" data-testid="purchaseinvoiceformdialog-taxes-included-switch"
                                                    />
                                                </FormControl>
                                            </FormItem>
                                        )}
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <Select onValueChange={(value) => {
                                                        ...
                                                        <FormControl>
                                                            <SelectTrigger id="purchaseinvoiceformdialog-selecttrigger-5" data-testid="purchaseinvoiceformdialog-discount-type-select">
                                                ...
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input
                                                            ...
                                                            className="text-right [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" id="purchaseinvoiceformdialog-input-0" data-testid="purchaseinvoiceformdialog-discount-value-input"
                                                        />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                ...
                                <TabsContent value="images" className="mt-4 space-y-2">
                                    ...
                                    <div className="grid grid-cols-5 gap-2">
                                            ...
                                            <div key={index} className="relative group aspect-square">
                                                ...
                                                {!readOnly && (
                                                    <Button
                                                        ...
                                                        onClick={() => handleRemoveImage(index)} id="purchaseinvoiceformdialog-button-2" data-testid="purchaseinvoiceformdialog-close-button"
                                                    >
                                                        <X className="h-4 w-4" />
                                                    </Button>
                                                )}
                                        ...
                                        {!readOnly && Array.from({ length: MAX_IMAGES - imageUrls.length }).map((_, index) => (
                                            <button
                                                ...
                                                onClick={() => fileInputRef.current?.click()} id="purchaseinvoiceformdialog-button-1-1" data-testid="purchaseinvoiceformdialog-add-button"
                                            >
                                    ...
                                    {!readOnly && (
                                        <Input
                                            ...
                                            accept="image/*"
                                            multiple
                                            className="hidden" id="purchaseinvoiceformdialog-input-3" data-testid="purchaseinvoiceformdialog-image-input"
                                        />
                                    )}
                ...
                <div className="mt-auto flex-shrink-0 space-y-4 pt-4">
                    ...
                    <DialogFooter>
                        <Button type="button" variant="outline" onClick={() => onOpenChange(false)} id="purchaseinvoiceformdialog-button-3" data-testid="purchaseinvoiceformdialog-action-button">{readOnly ? 'Cerrar' : 'Cancelar'}</Button>
                        {readOnly && purchaseInvoice ? (
                            <Button type="button" onClick={handleDownloadPdf} id="purchaseinvoiceformdialog-button-exportar-a-pdf" data-testid="purchaseinvoiceformdialog-action-export-button">
                                <Download className="mr-2 h-4 w-4" />
                                Exportar a PDF
                            </Button>
                        ) : (
                            <Button type="submit" form="purchase-invoice-form" disabled={isPending || (!purchaseInvoice && isProfileLoading)} id="purchaseinvoiceformdialog-button-4" data-testid="purchaseinvoiceformdialog-submit-button">
