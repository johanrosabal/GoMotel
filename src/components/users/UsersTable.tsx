        ...
        <>
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button variant="ghost" size="icon" disabled={isPending} id="userstable-button-1" data-testid="userstable-button-1">
    ...
    <div className="space-y-4">
      <div className="flex items-center gap-4">
        <Input
          ...
          className="max-w-sm" id="userstable-input-buscar-por-nombre" data-testid="userstable-input-buscar-por-nombre"
        />
        <Select value={roleFilter} onValueChange={(value) => setRoleFilter(value as any)}>
          <SelectTrigger className="w-[180px]" id="userstable-selecttrigger-1" data-testid="userstable-selecttrigger-1">
