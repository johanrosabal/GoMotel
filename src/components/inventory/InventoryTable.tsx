    ...
    return (
        <>
            <DropdownMenu>
                ...
                <Button aria-haspopup="true" size="icon" variant="ghost" disabled={isPending} id="inventorytable-button-1" data-testid="inventorytable-button-1">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-end bg-muted/20 p-4 rounded-xl border">
            <div className="grid gap-2 w-full md:flex-1">
                ...
                <div className="relative">
                    ...
                    <Input
                        ...
                        className="pl-9 bg-background" id="inventorytable-input-buscar-por-nombre" data-testid="inventorytable-input-buscar-por-nombre"
                    />
                </div>
            </div>
            <div className="grid gap-2 w-full md:w-48">
                ...
                <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                    <SelectTrigger className="bg-background" id="inventorytable-selecttrigger-1" data-testid="inventorytable-selecttrigger-1">
