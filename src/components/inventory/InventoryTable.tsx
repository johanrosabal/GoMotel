            ...
            <div className="flex flex-col md:flex-row gap-4 items-end bg-muted/20 p-4 rounded-xl border">
                <div className="grid gap-2 w-full md:flex-1">
                    ...
                    <div className="relative">
                        ...
                        <Input
                            ...
                            className="pl-9 bg-background" id="inventorytable-input-buscar-por-nombre" data-testid="inventorytable-search-input"
                        />
                    </div>
                </div>
                <div className="grid gap-2 w-full md:w-48">
                    ...
                    <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                        <SelectTrigger className="bg-background" id="inventorytable-selecttrigger-1" data-testid="inventorytable-category-select">
