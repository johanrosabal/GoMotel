            ...
            <TooltipProvider>
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Button variant="outline" size="icon" className="h-8 w-8" asChild id="supplierstable-button-1" data-testid="supplierstable-button-1">
                            <a href={gmapsUrl} target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()} data-testid="supplierstable-a-1">
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Button variant="outline" size="icon" className="h-8 w-8" asChild id="supplierstable-button-2" data-testid="supplierstable-button-2">
                            <a href={wazeUrl} target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()} data-testid="supplierstable-a-2">
        ...
        <>
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button variant="ghost" size="icon" id="supplierstable-button-3" data-testid="supplierstable-button-3"><MoreHorizontal className="h-4 w-4" /></Button>
                </DropdownMenuTrigger>
