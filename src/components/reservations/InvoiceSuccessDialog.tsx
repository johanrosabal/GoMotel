...
export default function InvoiceSuccessDialog({ open, onOpenChange, invoiceId }: InvoiceSuccessDialogProps) {
    ...
    const whatsappMessage = invoice ? encodeURIComponent(`¡Gracias por su pago! Su factura #${invoice.invoiceNumber} por un monto de ${formatCurrency(invoice.total)} ha sido generada.`) : '';
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                ...
                <DialogFooter className="flex-col sm:flex-row sm:justify-center gap-2">
                    ...
                    <Button type="button" variant="outline" asChild className="bg-green-500 text-white hover:bg-green-600 hover:text-white" disabled={isLoading || !invoice}>
