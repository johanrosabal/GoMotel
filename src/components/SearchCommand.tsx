  ...
  return (
    <>
      <Button
        ...
        className="relative h-10 w-full justify-start rounded-xl bg-background text-sm font-medium text-muted-foreground shadow-sm transition-all group sm:pr-12 md:w-40 lg:w-72 border-primary/10 hover:border-primary/30" id="searchcommand-button-1" data-testid="searchcommand-search-button"
      >
