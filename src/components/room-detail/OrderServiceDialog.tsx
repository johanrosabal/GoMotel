        ...
        <>
            <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogContent className="sm:max-w-4xl max-h-[90vh] flex flex-col">
                                        ...
                                        {activeServices.map((service) => (
                                            <div key={service.id} className="flex items-center justify-between p-2 rounded-md border">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <Button type="button" size="icon" variant="outline" className="h-7 w-7" onClick={() => handleRemoveFromCart(service)} disabled={getCartQuantity(service.id) === 0} id="orderservicedialog-button-1" data-testid="orderservicedialog-action-remove-button">
                                                        <Minus className="h-4 w-4" />
                                                    </Button>
                                                    <span className="w-6 text-center">{getCartQuantity(service.id)}</span>
                                                    <Button type="button" size="icon" variant="outline" className="h-7 w-7" onClick={() => handleAddToCart(service)} disabled={service.source !== 'Internal' && getCartQuantity(service.id) >= service.stock} id="orderservicedialog-button-2" data-testid="orderservicedialog-action-add-button">
                                                                    ...
                                                                    <div className="flex items-center gap-2">
                                                                        ...
                                                                        {item.service.source === 'Internal' && (
                                                                            <button
                                                                                ...
                                                                                )} id="orderservicedialog-button-1-1" data-testid="orderservicedialog-action-note-button"
                                                                            >
                    ...
                    {step === 2 && (
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(handleSubmit)} id="order-payment-form" data-testid="orderservicedialog-main-form">
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                                                    ...
                                                    <FormControl>
                                                        <Switch
                                                            checked={field.value}
                                                            onCheckedChange={field.onChange} id="orderservicedialog-switch-1" data-testid="orderservicedialog-1-switch"
                                                        />
                                                    </FormControl>
                                                </FormItem>
                                            )}
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            ...
                                                            <Select onValueChange={field.onChange} value={field.value}>
                                                                <FormControl>
                                                                    <SelectTrigger id="orderservicedialog-selecttrigger-1" data-testid="orderservicedialog-1-select">
                                                                    ...
                                                                    render={({ field }) => (
                                                                        <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border bg-background p-4 shadow-sm">
                                                                            <FormControl>
                                                                                <Checkbox
                                                                                    checked={field.value}
                                                                                    onCheckedChange={field.onChange} id="orderservicedialog-checkbox-1" data-testid="orderservicedialog-1-checkbox"
                                                                                />
                                                                            </FormControl>
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                ...
                                                                <FormControl><Input placeholder="Ingrese el número de voucher" {...field} id="orderservicedialog-input-ingrese-el-n-mero" data-testid="orderservicedialog-1-input" /></FormControl>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
                                                    />
                                                        ...
                                                        <FormItem>
                                                            ...
                                                            <FormControl>
                                                                <Input
                                                                    ...
                                                                    className="text-right" id="orderservicedialog-input-monto-recibido" data-testid="orderservicedialog-2-input"
                                                                />
                                                            </FormControl>
                                                        </FormItem>
                    ...
                    <DialogFooter className="mt-auto pt-4 border-t">
                        {step === 1 && (
                            <>
                                <Button type="button" variant="outline" onClick={() => setOpen(false)} id="orderservicedialog-button-cancelar" data-testid="orderservicedialog-cancel-button">
                                    Cancelar
                                </Button>
                                <Button type="button" onClick={() => setStep(2)} disabled={cart.length === 0} id="orderservicedialog-button-siguiente" data-testid="orderservicedialog-next-button">
                                    Siguiente
                                </Button>
                            </>
                        )}
                        {step === 2 && (
                            <>
                                <Button type="button" variant="outline" onClick={() => setStep(1)} id="orderservicedialog-button-atr-s" data-testid="orderservicedialog-action-back-button">
                                    Atrás
                                </Button>
                                <Button type="button" variant="secondary" onClick={() => handleSubmit({ payNow: false })} disabled={isPending} id="orderservicedialog-button-dejar-pendiente" data-testid="orderservicedialog-action-pending-button">
                                    Dejar Pendiente
                                </Button>
                                <Button type="button" onClick={form.handleSubmit(handleSubmit)} disabled={isPending} id="orderservicedialog-button-pagar-y-confirmar" data-testid="orderservicedialog-action-pay-button">
                                    Pagar y Confirmar
                                </Button>
                            </>
                        )}
                        {step === 3 && (
                            <Button type="button" onClick={() => {
                                setOpen(false);
                            }} id="orderservicedialog-button-cerrar" data-testid="orderservicedialog-close-button">
                                Cerrar
                            </Button>
                        )}
                    </DialogFooter>
                    ...
                    <div className="py-4 space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                autoFocus data-testid="orderservicedialog-1-textarea"
                            />
                        </div>
                    </div>
                    <DialogFooter className="gap-2">
                        <Button variant="outline" className="flex-1 font-bold" onClick={() => setNoteDialogOpen(false)} id="orderservicedialog-button-cancelar-1" data-testid="orderservicedialog-cancel-button">Cancelar</Button>
                        <Button className="flex-1 font-bold" onClick={handleSaveNote} id="orderservicedialog-button-guardar-nota" data-testid="orderservicedialog-save-button">Guardar Nota</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
        </>
