                ...
                <div className="p-6">
                    ...
                    <ScrollArea className="max-h-[60vh] pr-4">
                        {step === 1 ? (
                            ...
                            <Form {...form}>
                                <form id="checkout-payment-form" className="space-y-4 py-2" onSubmit={(e) => e.preventDefault()} data-testid="checkoutdialog-main-form">
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="space-y-3">
                                                ...
                                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                    <FormControl>
                                                        <SelectTrigger className="h-12 text-base font-bold" id="checkoutdialog-selecttrigger-1" data-testid="checkoutdialog-method-select">
                                        ...
                                        <div className="p-4 rounded-xl bg-muted/30 border space-y-4">
                                            <div className="space-y-2">
                                                ...
                                                <Input
                                                    ...
                                                    className="h-12 text-right text-xl font-bold" id="checkoutdialog-input-0-00" data-testid="checkoutdialog-cash-received-input"
                                                />
                                            </div>
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border bg-background p-4 text-left shadow-sm">
                                                                <FormControl>
                                                                    <Checkbox checked={field.value} onCheckedChange={field.onChange} id="checkoutdialog-checkbox-1" data-testid="checkoutdialog-payment-confirmed-checkbox" />
                                                                </FormControl>
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input placeholder="Ingrese el código de transacción" {...field} className="h-12 font-mono text-center text-lg" id="checkoutdialog-input-ingrese-el-c-digo" data-testid="checkoutdialog-voucher-input" />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                    ...
                    <DialogFooter className="gap-2 pt-4 border-t">
                        {step === 1 ? (
                            <>
                                <Button type="button" variant="outline" onClick={() => setOpen(false)} className="flex-1 h-12" disabled={isPending} id="checkoutdialog-button-cancelar" data-testid="checkoutdialog-cancel-button">Cancelar</Button>
                                <Button
                                    type="button"
                                    onClick={onNextStep}
                                    className={cn(
                            ...
                            <>
                                <Button type="button" variant="ghost" onClick={() => setStep(1)} disabled={isPending} className="h-12" id="checkoutdialog-button-volver" data-testid="checkoutdialog-back-button">
                                ...
                                <Button
                                    ...
                                    variant="destructive"
                                    className="flex-1 h-12 font-black uppercase tracking-wider shadow-red-500/20 shadow-xl" id="checkoutdialog-button-2" data-testid="checkoutdialog-action-button"
                                >
                                    {isPending ? 'Procesando...' : (
                                        <>
