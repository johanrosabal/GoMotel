        ...
        <div className="flex items-start gap-4">
            ...
            <div>
                ...
                <div className="mt-1 text-sm text-muted-foreground space-y-2">
                    <p><b>Uso:</b> {usage}</p>
                    <p><b>Caso de Uso Profesional:</b> {useCase} <Link href={href} className="text-primary underline font-bold" id="page-link-ir-a-la" data-testid="operations-link-ir-a-la">Ir a la sección.</Link></p>
                </div>
            </div>
        </div>
    )
