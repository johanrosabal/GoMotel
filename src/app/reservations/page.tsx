...
export default function ReservationsPage() {
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col relative overflow-hidden">
        ...
        <div className="container relative z-10 py-8 lg:py-10 space-y-8 max-w-7xl">
            {/* Header Section */}
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/5 pb-8">
                <div className="space-y-4">
                    <div className="flex items-center gap-4 group">
                        ...
                        <div>
                            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black uppercase italic tracking-tighter leading-none flex flex-wrap gap-x-4 items-baseline">
                                <span className="text-white">Gestión de</span>
                                <span className="text-primary">Reservaciones</span>
                            </h1>
                        </div>
                    </div>
                    <p className="text-slate-400 text-[10px] font-bold uppercase tracking-[0.2em] max-w-xl pl-2 blur-[0.4px]">
