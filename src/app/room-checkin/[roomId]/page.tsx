                ...
                <AnimatePresence mode="wait">
                    ...
                    {status === 'success' && (
                        ...
                        >
                            ...
                            <Button asChild variant="outline" className="rounded-2xl border-white/10 hover:bg-white/5 font-bold uppercase tracking-widest text-[10px] w-full h-12" data-testid="roomid-action-button">
                                <Link href="/" data-testid="roomid-1-link">
                    ...
                    {status === 'error' && (
                        ...
                        >
                            ...
                            <Button asChild variant="outline" className="rounded-2xl border-white/10 bg-white/5 font-bold uppercase tracking-widest text-[10px] w-full" data-testid="roomid-action-button">
                                <Link href="/" data-testid="roomid-2-link">Reintentar</Link>
                            </Button>
                        </motion.div>
                    )}
                </AnimatePresence>
