...
export default function EditRoomTypePage() {
  ...
  return (
     <div className="container py-4 sm:py-6 lg:py-8 space-y-6">
      <div className="flex items-center gap-4">
         <Button asChild variant="outline" size="icon" id="page-button-1" data-testid="[id]-button-1">
            <Link href="/settings/room-types" id="page-link-settings-room-types" data-testid="[id]-link-settings-room-types">
              <ArrowLeft />
